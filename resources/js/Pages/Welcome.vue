...
<template>
  ...
  <div class="flex min-h-screen bg-gray-50 text-gray-900">
    <div v-if="$page.props.auth.user" class="p-6 border-r flex flex-col gap-4 w-72">
      <Link :href="route('home')" class="text-lg font-medium hover:text-blue-600 transition duration-300">Início</Link>
      <Link :href="route('dashboard')" class="text-lg font-medium hover:text-blue-600 transition duration-300">Perfil</Link>
    </div>
